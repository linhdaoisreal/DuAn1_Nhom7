                ...
                <div class="flex flex-row justify-end items-center gap-2 pr-1">
                    ...
                    <div class="relative" onclick="toggleDropdown()">
                        <div class="flex items-center ">
                            <img id="userDropdownButton" class="mr-3 object-cover" style="width:35px;height:35px;border-radius: 50%"
                                src="./gallery/<?= $anh_dai_dien?>" alt="">
                            <p  class="font-semibold text-orange-400 cursor-pointer hidden md:block">
                                <?= $ho_ten ?></p>
                        </div>
