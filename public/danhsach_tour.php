                ...
                <div class="grid grid-row-1 w-full bg-transparent">
                    <div
                        ...
                        <div class="m-3 flex items-center justify-between mt-auto col-start-1 col-end-2">
                            <h2 class="text-white text-2xl font-bold underline transition duration-400 ease-in">Ninh
                                Bình</h2>
                ...
                <div class="grid grid-row-1 w-full bg-transparent">
                    <div
                        ...
                        <div class="m-3 flex items-center justify-between mt-auto col-start-1 col-end-2">
                            ...
                            <button
                                class="text-center font-semibold text-white hover:font-bold p-3 bg-cyan-500 rounded-lg">Đặt
                                ngay</button>
                        </div>
                    </div>
                </div>
