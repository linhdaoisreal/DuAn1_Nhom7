...
<section>
    ...
    function confirmBooking() {
        var confirmDiscount = confirm(
            "Ngày xuất phát bạn chọn còn cách khá xa. Bạn có muốn đặt cọc 50% giá trị không? (Chọn OK: Để đặt cọc Cancel: Để thanh toán đầy đủ)"
            );
        if (confirmDiscount) {
            // Tạo phần tử input
