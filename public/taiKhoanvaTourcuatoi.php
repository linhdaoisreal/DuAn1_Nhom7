            ...
            <?php if ($login): ?>
                ...
                <div class="flex-row md:col-span-2 leading-9">
                    ...
                    <div class="items-center flex justify-center mt-4">
                        <img style="width:200px;height:200px;border-radius:50%" src="./gallery/<?= $anh_dai_dien ?>" alt=""
                            class="object-cover"><br>
                    </div>
                    <p class="font-medium mt-6 text-lg text-cyan-900">Tên người dùng: <span
                        ...
                        echo '
                            <div class="w-full my-3 border rounded-lg flex px-4 grid-cols-2 gap-4">
                                    ...
                                    <div class="my-auto text-sm md:text-base">
                                        ...
                                        <h1 class="font-semibold"> Trạng thái: <span class="font-normal">';
                                            if ($trang_thai == 1) {
                                        ...
                                        echo '</span></h1>
                                        <p class="font-semibold">Ngày khởi hành: <span class="font-normal">' . $ngay_khoi_hanh . '</span></p>
                                        <p class="font-semibold">Số người đăng kí: <span class="font-normal">' . $tong_nguoi . '</span></p>
                                    </div>
                                </div> 
                            ';
                    }
