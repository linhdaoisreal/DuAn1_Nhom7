...
<!-- BANNER -->
    <section class="">
        <div class="grid md:grid-cols-4 w-full flex-col">
            ...
            <!-- Banner 2 -->
            <div class="h-28 hover:h-[450px] bg-cover bg-no-repeat transition ease-in-out duration-1000 md:grid-cols-1 md:h-[450px] " style="background-image: url(./src/img/banner2.jpg); transition: background-image 1s;">
                <div class="flex flex-col justify-evenly items-center py-5 hover:py-44 md:py-44">
            ...
            <!-- Banner 3 -->
            <div class="h-28 hover:h-[450px] bg-cover bg-no-repeat transition ease-in-out duration-1000 md:grid-cols-1 md:h-[450px] " style="background-image: url(./src/img/banner3.jpg); transition: background-image 1s;">
                <div class="flex flex-col justify-evenly items-center py-5 hover:py-44 md:py-44">
            ...
            <!-- Banner 4 -->
            <div class="h-28 hover:h-[450px] bg-cover bg-no-repeat transition ease-in-out duration-1000 md:grid-cols-1 md:h-[450px] " style="background-image: url(./src/img/banner4.jpg); transition: background-image 1s;">
                <div class="flex flex-col justify-evenly items-center py-5 hover:py-44 md:py-44">
