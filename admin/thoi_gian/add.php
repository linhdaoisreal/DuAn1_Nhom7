<div class="row flex flex-col flex-1 overflow-y-auto">
    <div class="">
        <h1 class="text-center text-3xl bg-orange-300 text-white my-0.5 mt-3.5 rounded-md h-11">Thêm Hạng Thời Gian</h1>
    </div>
    <!-- Form nhập thêm mùa -->
    <div class="ml-10 mt-8">
        <form action="index.php?act=add_thoi_gian" method="post">
          
            <div class="row mb">
                <label for="" class="text-lg font-semibold text-orange-300">ID Thời Gian</label><br>
                <input type="text" name="id_thoi_gian" disabled class="border-orange-300 w-96 border-2 rounded-lg h-9">
            </div>
            ...
            <div class="mt-8">
                ...
                <input type="text" name="muc_tang" id="muc_tang" class="border-orange-300 w-96 border-2 rounded-lg h-9">
                <span id="muc_tang_error" class="text-red-500"></span>
            </div>
            ...
            <div class="mt-8">
                <input type="submit" name="add_thoi_gian" value="Thêm mới"
